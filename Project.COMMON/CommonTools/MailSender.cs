...
namespace Project.COMMON.CommonTools
{
    ...
    {
        public static void Send(string receiver, string password = "cagrininKedicikleri+1canimFurkanim", string body = "Deneme", string subject = "Test", string sender = "bayms3132@gmail.com")
        {
